...
- [x] كتابة 15 اختبار vitest (جميعها ناجحة)
- [x] حفظ checkpoint (version: acc94582)

## ميزة استنساخ الصوت الرقمي (Voice Cloning) - USP
- [x] إنشاء جدول voice_clones في قاعدة البيانات (معرف، معرف المستخدم، حالة، رابط الملف الصوتي، معرف الصوت المستنسخ)
- [x] إنشاء جدول leader_points لنظام النقاط/الرصيد (معرف، معرف المستخدم، رصيد، سجل المعاملات)
- [x] إنشاء جدول points_transactions لسجل المعاملات المالية
- [x] إنشاء endpoint لرفع التسجيل الصوتي إلى S3
- [x] إنشاء endpoint لإنشاء البصمة الصوتية (Voice Clone API)
- [x] إنشاء endpoint لتوليد صوت بالبصمة المستنسخة
- [x] إنشاء endpoints لإدارة النقاط (عرض الرصيد، خصم عند الاستخدام، سجل المعاملات)
- [x] بناء واجهة تسجيل البصمة الصوتية في إعدادات المعلم (Web Audio API) - صفحة /my-voice
- [x] إضافة قائمة منسدلة في Edu-Studio لاختيار الصوت (AI جاهز / صوتي المستنسخ)
- [x] برمجة Credit Guard لخصم النقاط عند استخدام الصوت المستنسخ
- [x] بناء صفحة نقاط ليدر /my-points مع عرض الرصيد وسجل المعاملات
- [x] كتابة 19 اختبار vitest (جميعها ناجحة)
- [x] حفظ checkpoint (version: 438f07bd)

## ربط ElevenLabs API الحقيقي لاستنساخ الصوت
- [ ] مراجعة الكود الحالي لتحديد نقاط الدمج
...
- [x] مراجعة صفحة دورة إعداد الفيديو بالذكاء الاصطناعي
- [x] إضافة قسم أدوات AI مع روابط (صوتي الرقمي، نقاطي، Edu-Studio)
- [x] التحقق من العرض وحفظ checkpoint

## إضافة محسن الأوامر ومقيم الفيديو إلى صفحة الدورة
- [x] إضافة بطاقة محسن الأوامر (Prompt Lab) إلى قسم أدوات AI
- [x] إضافة بطاقة مقيم الفيديو (Video Evaluator) إلى قسم أدوات AI
- [x] حفظ checkpoint

## إضافة أداة المخرج الذكي إلى صفحة الدورة
- [x] إضافة بطاقة المخرج الذكي (AI Director) إلى قسم أدوات AI
- [x] حفظ checkpoint

## إنشاء صفحة مركز الأدوات (AI Tools Hub)
- [x] جرد جميع أدوات AI المتاحة ومساراتها (16 أداة في 6 فئات)
- [x] بناء صفحة مركز الأدوات مع بطاقات مفصلة وتصنيفات
- [x] تسجيل المسار /ai-hub في App.tsx وإضافة رابط في قائمة التنقل
- [x] حفظ checkpoint

## تفعيل مفتاح ElevenLabs API الحقيقي
- [x] إدخال مفتاح ElevenLabs API الجديد بصلاحيات كاملة
- [x] اختبار صلاحية المفتاح (4/4 اختبارات ناجحة)
...
## إظهار معاينة مقفلة للأدوات للزوار غير المسجلين
- [x] تعديل شرط عرض أدوات AI ليظهر لجميع الزوار
...
## الهوية البصرية للفيديو المُصدّر (Video Branding)
- [x] إضافة علامة مائية ذكية "Created via Leader Academy" شفافة طوال الفيديو
- [x] إنشاء شاشة بداية (Intro Card) 3 ثوانٍ بألوان البراند مع عنوان الدرس واسم المعلم
- [x] إنشاء شاشة نهاية تسويقية (Outro Card) 3 ثوانٍ مع شعار الأكاديمية وعبارة تحفيزية
- [x] توحيد دقة الصور إلى 1080p (1920x1080) بمقاس 16:9 قبل الدمج
- [x] تمرير عنوان الدرس واسم المعلم من UltimateStudio إلى محرك الرندرة
- [x] تحديث اختبارات vitest (14 اختبار ناجح)
- [ ] حفظ checkpoint

## إضافة خيارات متعددة لتحميل الفيديو في مقيّم الفيديو
- [x] إضافة تبويبات إدخال: رفع ملف / رابط يوتيوب / رابط مباشر / تسجيل من الكاميرا
- [x] إنشاء backend endpoint لاستخراج معلومات فيديو يوتيوب
- [x] إنشاء backend endpoint لتحميل فيديو من رابط مباشر
- [x] تحديث واجهة المستخدم مع تبويبات أنيقة لكل خيار
- [x] إضافة معاينة الفيديو قبل الإرسال
- [x] كتابة اختبارات vitest (63 اختبار ناجح)
- [x] حفظ checkpoint

## إضافة دعم Google Drive/Dropbox لاستيراد الفيديو
- [x] إضافة تبويب خامس "تخزين سحابي" في واجهة مقيّم الفيديو
- [x] دعم لصق روابط Google Drive مع استخراج رابط التحميل المباشر
- [x] دعم لصق روابط Dropbox مع تحويلها لروابط تحميل مباشر
- [x] إضافة أيقونات Google Drive و Dropbox مميزة
- [x] معاينة الفيديو بعد التحقق من الرابط

## تقطيع تلقائي للفيديو الطويل (أكثر من 16MB)
- [x] إنشاء مكون VideoTrimmer يعمل في المتصفح
- [x] إضافة شريط تحديد المقطع (Start/End) مع معاينة
- [x] عرض تنبيه تلقائي عند تجاوز حجم الملف 16MB
- [x] استخدام FFmpeg.wasm لقص المقطع المحدد
- [x] إعادة حساب الحجم بعد القص والتأكد من أنه أقل من 16MB

## مقارنة بين تقييمات متعددة (رسم بياني)
- [x] إضافة قسم "تحليل التقدم" في تبويب History
- [x] رسم بياني خطي يعرض تطور النتيجة الإجمالية عبر التقييمات
...
## صفحة الهبوط الاحترافية (CRO Landing Page)
- [x] Hero Section: عنوان رئيسي + فرعي + CTA + خلفية متحركة
- [x] قسم السحر التقني: 3 بطاقات كبيرة (تحضير بيداغوجي، استوديو فيديو، استنساخ صوتي)
- [x] قسم الآلة الحاسبة: عداد توفير الوقت (15 ساعة → 3 ساعات)
- [x] قسم الأسئلة الشائعة (FAQ)
- [x] تذييل الصفحة مع جدول الباقات الثلاث
- [x] اختبار الصفحة وتحسين الأداء (vitest) - 19 اختبار ناجح
- [ ] حفظ checkpoint

## نظام التوطين الشامل (Strict i18n Localization)
- [x] تحليل نظام اللغات الحالي وتحديد النصوص الثابتة
- [x] بناء نظام ترجمة مركزي (AR/FR/EN) - ultimateStudioTranslations.ts (80+ مفتاح)
- [x] تطبيق i18n على صفحة Ultimate Studio (أزرار، حقول، رسائل خطأ، stepper)
- [x] تطبيق i18n على صفحة الهبوط والصفحات الرئيسية (تستخدم t() بالفعل)
...
## فتح استنساخ الصوت لمشاركي دورة الفيديو بالذكاء الاصطناعي
- [x] تحليل نظام التحكم في الوصول (isVIP في UltimateStudio)
- [x] تحديث الشرط ليشمل المشاركين (courseId: 30001 + digital_teacher_ai)
- [x] اختبار التغييرات (16 اختبار ناجح)
- [x] حفظ checkpoint

## صفحة أدوات دورة إعداد الفيديوهات بالذكاء الاصطناعي
- [ ] تحليل البنية الحالية للدورات والأدوات المتاحة
- [ ] بناء صفحة أدوات الدورة مع بطاقات تفاعلية وشرح استخدام كل أداة
- [ ] تسجيل المسار في App.tsx وربطه بالتنقل
- [ ] كتابة اختبارات vitest
- [ ] حفظ checkpoint

## صندوق أدوات الدورة (Course Toolkit Page)
- [x] إنشاء صفحة CourseToolkit.tsx مع بطاقات تفاعلية لـ 7 أدوات
- [x] تطبيق هيكل الشرح البيداغوجي لكل أداة (ماذا تفعل؟ لماذا تحتاجها؟ كيف تستخدمها؟ ماذا لو لم تستخدمها؟)
- [x] إضافة خطوات استخدام تفصيلية قابلة للتوسيع لكل أداة
- [x] إضافة نصائح احترافية لكل أداة
- [x] إضافة قسم البدء السريع (Quick Start) مع 6 خطوات مرئية
- [x] دعم 3 لغات (عربي/فرنسي/إنجليزي) مع RTL/LTR
- [x] التحقق من تسجيل المستخدم في الدورة (courseId: 30001)
- [x] تسجيل المسار /course-toolkit في App.tsx
- [x] إضافة زر "افتح صندوق أدوات الدورة" في صفحة تفاصيل الدورة
- [x] كتابة 16 اختبار vitest ناجح (ترجمات، تعريفات الأدوات، البنية، التحكم في الوصول)

## تحسين Ultimate Studio - استخراج النص وتوليد الصور
- [x] دعم استخراج النص من ملفات JPG/PNG بالإضافة إلى PDF
- [x] دعم استخراج النص من ملفات DOC/DOCX
- [x] إضافة اختيار عدد الصفحات (1-3 صفحات) مع النص
- [x] إضافة اختيار نمط الصور (واقعي، كرتون، خطي، تعليمي، ألوان مائية، رسم أطفال)
- [x] إضافة زر تحسين البرومبت تلقائياً بالذكاء الاصطناعي
- [x] إضافة زر إعادة توليد الصورة مع تعديل البرومبت يدوياً
- [x] كتابة 16 اختبار vitest للميزات الجديدة (كلها ناجحة)

## تحسين عرض Ultimate Studio على الهاتف (Android)
- [x] تحويل التخطيط من 3 أعمدة ثابتة إلى تخطيط متجاوب مع الشاشات الصغيرة
- [x] إضافة نظام تبويبات (tabs) للتنقل بين الأقسام الثلاثة على الهاتف
- [x] تحسين شريط الأدوات العلوي للهاتف (أزرار بأيقونات فقط على الهاتف)
- [x] تحسين أزرار التحميل والاستخراج للشاشات الصغيرة
- [x] اختبار التجاوب على أحجام شاشات مختلفة (21 اختبار ناجح)
- [x] حفظ checkpoint

## إصلاح المساعد البيداغوجي (EduGPT)
- [x] تحليل سبب البطء في استجابة المساعد البيداغوجي
- [x] تقليص البرومبت من 17908 إلى 9388 حرف (-48%) مع الحفاظ على المراجع الأساسية
- [x] تحديد تاريخ المحادثة بآخر 12 رسالة + max_tokens: 4096
- [x] إصلاح CSS للجداول داخل فقاعات المحادثة الزرقاء + فقاعات متجاوبة 85vw
- [x] كتابة 17 اختبار vitest (كلها ناجحة)
- [x] حفظ checkpoint

## تحويل المساعد البيداغوجي إلى تجربة Manus-like متكاملة
- [x] تحليل الكود الحالي وتخطيط الميزات الجديدة
- [x] تحسين واجهة المحادثة (موجودة مسبقاً: لوحة عائمة + تكبير/تصغير)
- [x] شريط جانبي لتاريخ المحادثات مع بحث (موجود مسبقاً)
- [x] إضافة 6 أزرار إجراءات سريعة (جذاذة، اختبار، دراما، توزيع سنوي، تمارين، صورة تعليمية)
- [x] إضافة تحميل مباشر PDF/Word من كل رد (أزرار مدمجة في كل رسالة)
- [x] إضافة سحب وإفلات الملفات (drag & drop) مع تأثير بصري
- [x] معاينة المستندات داخل المحادثة (موجودة مسبقاً: مرفقات الرسائل)
- [x] رسالة ترحيب مخصصة (موجودة مسبقاً: تسأل عن المادة والمستوى)
- [x] tags للمحادثات (موجودة مسبقاً: مذكرة، تقييم، توزيع سنوي)
- [x] حفظ المحادثات في قاعدة البيانات (موجود مسبقاً)
- [x] كتابة 14 اختبار vitest (كلها ناجحة)
- [x] حفظ checkpoint

## إضافة البث المباشر (Streaming) لردود المساعد البيداغوجي
- [x] تحليل الكود الحالي لاستدعاء LLM وتدفق الرسائل
- [x] إنشاء endpoint SSE (/api/assistant/stream) للبث المباشر
- [x] استدعاء LLM API مع stream: true وإعادة إرسال الأجزاء تدريجياً
- [x] تحديث الواجهة الأمامية لاستهلاك الردود المتدفقة (fetch + ReadableStream)
- [x] عرض النص تدريجياً مع Streamdown + تمرير تلقائي
- [x] الحفاظ على التوافق مع الميزات الحالية (نسخ، تصدير، إعادة التوليد)
- [x] كتابة 18 اختبار vitest (كلها ناجحة)
- [x] حفظ checkpoint

## 🚨 إصلاح خطير: المساعد يرد بالفرنسية عندما يكتب المستخدم بالعربية
- [x] تحليل منطق اكتشاف اللغة: المشكلة في التعيين التلقائي للفرنسية + البرومبت يفرض لغة التدريس
- [x] إصلاح أولوية اللغة: قاعدة مطلقة "رد بلغة رسالة المستخدم الأخيرة" في 3 أماكن
- [x] تحديث البرومبت في streamChat.ts: langNote + buildSystemPrompt
...
## تحسينات تصدير الفيديو في Ultimate Studio
- [x] شريط تقدم مفصّل يعرض النسبة المئوية لكل مشهد أثناء التجميع
- [x] خيار جودة الفيديو (720p/1080p) قبل التصدير
- [x] معاينة سريعة للفيديو قبل التحميل النهائي
- [x] كتابة اختبارات vitest (28 اختبار ناجح)
- [x] حفظ checkpoint

## محرك معالجة الصوت الشامل (Batch Audio Engine)
- [x] زر التوليد الشامل "توليد الصوت لجميع المشاهد" مع معالجة تتابعية
- [x] شريط تقدم ديناميكي أثناء التوليد الشامل
- [x] نافذة إعدادات الصوت (توجيهات الأداء / Voice Prompt)
- [x] طبقة التشكيل الآلي (Auto-Tashkeel) عبر LLM للنصوص العربية
- [x] التحديث الحي للواجهة (Live UI Update) أثناء التوليد
- [x] ترجمات جديدة (عربي/فرنسي/إنجليزي)
- [x] اختبارات vitest (21 اختبار ناجح)
- [x] حفظ checkpoint

## إصلاح: المشرف لديه 0 نقاط ولا يمكنه توليد الصوت
- [x] تحليل نظام النقاط وإيجاد مكان إدارة نقاط المشرف
- [x] إصلاح النظام: admin/owner يحصل على 999,999 نقطة + إعادة ملء تلقائية + لا خصم فعلي
- [x] تحديث رصيد المشرف في قاعدة البيانات مباشرة
- [x] اختبار (21 اختبار ناجح)
- [x] حفظ checkpoint

## لوحة إدارة النقاط في Dashboard
- [x] تحليل هيكل لوحة الإدارة الحالية ونظام النقاط
- [x] إضافة إجراءات tRPC للإدارة (5 إجراءات: عرض/منح/خصم/منح جماعي/سجل/إحصائيات)
- [x] بناء واجهة لوحة إدارة النقاط (جدول + منح/خصم + سجل + منح جماعي)
- [x] دمج الصفحة في التنقل الجانبي للوحة التحكم
- [x] كتابة اختبارات vitest (54 اختبار ناجح)
- [x] حفظ checkpoint

## إصلاح: فشل تصدير الفيديو MP4 في Ultimate Studio
- [x] تحليل سبب الفشل (FFmpeg.wasm CORS/SharedArrayBuffer)
- [x] إعادة كتابة المحرك بالكامل باستخدام Canvas + MediaRecorder
...
## مراجعة الصفحة الرئيسية - 7 نقاط تحقق
- [ ] زر "ابدأ بـ 100 نقطة مجانية" يظهر بوضوح في navbar
- [ ] عنوان hero يقول "18 أداة" وليس "11 أداة"
- [ ] البطاقات الثلاثة في صف أفقي واحد
- [ ] accordion يعرض 7 أدوات لكل بطاقة
- [ ] لا يوجد محتوى "Test Teacher" أو 0 تحميلات
- [ ] الصفحة تعمل على الجوال
- [ ] اللغة موحدة عربياً


## Leader Studio - أزرار متقدمة بعد الجذاذة

- [ ] تثبيت مكتبات: mermaid, pptxgenjs
- [ ] الزر 1: مولد الخريطة الذهنية (MermaidJS mindmap)
- [ ] الزر 2: مولد Quiz تفاعلي (5 أسئلة اختيار من متعدد)
- [ ] الزر 3: مولد PowerPoint (5 شرائح PPTX)
- [ ] الزر 4: Ultimate Studio Redirect (localStorage + new window)
- [ ] شريط Studio UI مع 4 أزرار ملونة (بنفسجي، عنبري، أزرق، أخضر)
- [ ] اختبار الخريطة الذهنية والتقاط صورة
- [ ] اختبار Quiz والتصحيح الفوري
- [ ] اختبار تحميل PowerPoint
- [ ] اختبار Ultimate Studio redirect


## Leader Studio - أزرار متقدمة للمساعد البيداغوجي
- [x] الزر 1: خريطة ذهنية (Mind Map) - توليد Mermaid mindmap من الجذاذة
- [x] الزر 2: اختبار تفاعلي (Quiz) - 5 أسئلة اختيار من متعدد
- [x] الزر 3: عرض تقديمي (PowerPoint) - 5 شرائح تلقائية
- [x] الزر 4: Ultimate Studio - نقل المحتوى إلى صفحة جديدة
- [x] إصلاح ظهور الأزرار بعد انتهاء الـ streaming
- [x] تحسين الشروط والـ rendering
- [x] اختبار جميع الأزرار والتأكد من عملها


## Leader Studio - أزرار متقدمة
- [x] إضافة 4 أزرار (خريطة ذهنية، اختبار، عرض تقديمي، Ultimate Studio)
- [x] تطبيق الخريطة الذهنية مع Mermaid mindmap
- [x] تحويل الخريطة إلى صورة PNG باستخدام mermaid.ink API
- [x] إضافة رسوم بيانية (أعمدة، دائري، خطي) لبيانات الخريطة
- [x] إضافة تبويبات في Modal الخريطة الذهنية
- [x] إنشاء مهارة Leader Studio قابلة لإعادة الاستخدام
...
## قسم الأسئلة الشائعة (FAQ) لنظام الإحالات
- [x] إنشاء صفحة FAQ مع واجهة accordion عربية RTL
- [x] كتابة 20 سؤال وجواب شامل حول نظام الإحالات
- [x] شرح كيفية عمل النظام بالتفصيل
- [x] توضيح شروط الحصول على المكافآت
- [x] شرح حدود الإحالات والقيود
- [x] إضافة أمثلة عملية للسيناريوهات المختلفة
- [x] دمج صفحة FAQ في التنقل (App.tsx)
- [x] كتابة اختبارات vitest لصفحة FAQ
- [x] إضافة رابط FAQ في صفحة دعوة الأصدقاء
- [x] إضافة رابط FAQ في لوحة الإحالات
- [x] إضافة رابط FAQ في القائمة الجانبية (DashboardLayout)
- [x] حفظ checkpoint


## ميزة مشاركة الرابط على وسائل التواصل الاجتماعي
- [x] إنشاء مكون SocialShareButtons مع أزرار للمشاركة
- [x] إضافة أزرار Facebook و Twitter و WhatsApp و LinkedIn
- [x] كتابة رسائل مخصصة لكل منصة
- [x] دمج المشاركة في صفحة دعوة الأصدقاء
- [x] دمج المشاركة في لوحة الإحالات
- [x] إضافة نسخ الرابط مع رسالة النجاح
- [x] كتابة اختبارات vitest للمشاركة
- [x] اختبار المشاركة على جميع المنصات
- [x] حفظ checkpoint


## نظام الشارات (Badges) لمكافأة الإحالات
- [x] تصميم جدول قاعدة البيانات للشارات والإنجازات
- [x] إضافة أنواع شارات مختلفة (برونز، فضة، ذهب، بلاتين)
- [x] إنشاء إجراءات tRPC للتحقق من الشارات وإصدارها
- [x] بناء مكون عرض الشارات مع تصميم بصري
- [x] إضافة رسوم توضيحية للشارات (Lucide Icons)
- [x] دمج الشارات في لوحة الإحالات
- [ ] عرض الشارات في صفحة الملف الشخصي
- [ ] إضافة تنبيهات عند الحصول على شارة جديدة
- [x] كتابة اختبارات vitest لنظام الشارات
- [ ] حفظ checkpoint
