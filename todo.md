...
- [ ] endpoint tRPC edugpt.inspectLesson بـ system prompt المتفقد العام (رتبة مميز، 30 سنة خبرة)
- [ ] معايير التقييم: الانسجام البيداغوجي، تمشّي الحصة، الدقة العلمية، هندسة الاختبارات، الإبداع الرقمي
- [ ] شكل التقرير: توطئة + نقاط القوة + الإخلالات + توصيات المتفقد + القرار النهائي
- [ ] زر "عرض على المتفقد الذكي" في صفحة EduGPT.tsx
- [ ] منطقة إدخال النص (لصق الجذاذة) + زر تحليل
- [ ] عرض تقرير التفقد بتصميم رسمي (ختم + ألوان رسمية)
- [ ] حفظ نقطة التفتيش
