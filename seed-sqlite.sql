-- ============================================
-- LEADER ACADEMY - SEED DATA (SQLite)
-- ============================================
...
('enroll-001', 4, 1, 'in_progress', 60, datetime('now')),
('enroll-002', 4, 2, 'enrolled', 0, datetime('now')),
('enroll-003', 5, 1, 'in_progress', 35, datetime('now')),
('enroll-004', 2, 3, 'completed', 100, datetime('now', '-30 days')),
('enroll-005', 3, 2, 'completed', 100, datetime('now', '-15 days'));
...
('prog-001', 1, 1, 'completed', 2700, datetime('now')),
('prog-002', 1, 2, 'in_progress', 1800, NULL),
('prog-003', 3, 1, 'in_progress', 1200, NULL),
('prog-004', 4, 3, 'completed', 2400, datetime('now', '-30 days')),
('prog-005', 4, 4, 'completed', 2100, datetime('now', '-28 days'));
...
('ubadge-001', 1, 1, datetime('now', '-60 days')),
('ubadge-002', 1, 2, datetime('now', '-45 days')),
('ubadge-003', 1, 3, datetime('now', '-30 days')),
('ubadge-004', 1, 4, datetime('now', '-15 days')),
('ubadge-005', 2, 1, datetime('now', '-40 days')),
('ubadge-006', 2, 2, datetime('now', '-25 days')),
('ubadge-007', 3, 1, datetime('now', '-35 days')),
('ubadge-008', 4, 1, datetime('now', '-20 days'));
...
('result-001', 4, 1, 85, 'passed', datetime('now', '-5 days'), datetime('now', '-4 days')),
('result-002', 5, 1, 72, 'passed', datetime('now', '-3 days'), datetime('now', '-2 days')),
('result-003', 2, 2, 95, 'passed', datetime('now', '-10 days'), datetime('now', '-9 days')),
('result-004', 3, 3, 88, 'passed', datetime('now', '-7 days'), datetime('now', '-6 days'));
...
('app-001', 4, 1, 'applied', 'I am interested in this teaching position', datetime('now')),
('app-002', 5, 2, 'applied', 'I have 3 years of web development experience', datetime('now')),
('app-003', 2, 4, 'shortlisted', 'I am an experienced AI trainer', datetime('now', '-5 days')),
('app-004', 3, 4, 'reviewing', 'I am passionate about AI education', datetime('now', '-3 days'));
...
('notif-001', 4, 'تم قبول طلبك', 'تم قبول طلبك للتقدم للوظيفة', 'success', 0, '/jobs/job-001'),
('notif-002', 5, 'دورة جديدة متاحة', 'دورة جديدة في مجال الذكاء الاصطناعي', 'info', 0, '/courses/course-001'),
('notif-003', 2, 'شهادة جديدة', 'تم إصدار شهادة لك', 'success', 1, '/certificates/cert-001'),
('notif-004', 1, 'تقرير شهري', 'تقرير الأداء الشهري جاهز', 'info', 0, '/analytics/monthly');
