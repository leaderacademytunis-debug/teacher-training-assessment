  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        icon: Film,
        nameAr: "Ultimate Studio — الاستوديو المتكامل",
        nameFr: "Ultimate Studio — Studio Intégré",
        nameEn: "Ultimate Studio — Integrated Studio",
        descAr: "من الكتاب المدرسي إلى الفيديو التعليمي في شاشة واحدة",
        descFr: "Du manuel scolaire à la vidéo éducative en un seul écran",
        descEn: "From textbook to educational video in a single screen",
        whatAr: "استوديو ثوري بثلاثة أعمدة يجمع مكتبة الكتب المدرسية وخط إنتاج الذكاء الاصطناعي ولوحة القصة المصورة في شاشة واحدة.",
        whatFr: "Un studio révolutionnaire à trois colonnes combinant bibliothèque de manuels, pipeline IA et storyboard en un seul écran.",
        whatEn: "A revolutionary three-column studio combining textbook library, AI pipeline and storyboard in a single screen.",
        whyAr: "لأن الإنتاج التعليمي يحتاج سير عمل متكامل — من استخراج النص إلى السيناريو إلى الصور والصوت في مكان واحد.",
        whyFr: "Parce que la production éducative nécessite un workflow intégré — de l'extraction de texte au scénario, images et audio en un seul endroit.",
        whyEn: "Because educational production needs an integrated workflow — from text extraction to script, images and audio in one place.",
        howAr: ["حمّل الكتاب المدرسي PDF", "استخرج نص الصفحة بالذكاء الاصطناعي", "ولّد السيناريو والصور والصوت", "صدّر المشروع كاملاً"],
        howFr: ["Charger le manuel PDF", "Extraire le texte par IA", "Générer scénario, images et audio", "Exporter le projet complet"],
        howEn: ["Load textbook PDF", "Extract text via AI", "Generate script, images & audio", "Export complete project"],
        gradient: "linear-gradient(135deg, #F59E0B, #D97706)",
        badgeAr: "جديد — الأداة الشاملة",
        badgeFr: "Nouveau — Outil complet",
        badgeEn: "New — Complete Tool",
        isNew: true,
        isExclusive: true,
      },
    ],
