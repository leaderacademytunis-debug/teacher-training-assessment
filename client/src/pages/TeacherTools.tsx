...
const BONUS_TOOLS: ToolDef[] = [
  ...
  {
    id: "repartition-journaliere",
    href: "/repartition-journaliere",
    icon: Calendar,
    nameAr: "التوزيع اليومي — Répartition Journalière",
    nameFr: "Répartition Journalière",
    nameEn: "Daily Schedule — Répartition Journalière",
    descAr: "توليد التوزيع اليومي لحصص اللغة الفرنسية وفق المنهج التونسي الرسمي مع تصدير PDF",
    descFr: "Générer la répartition journalière des séances de français selon le curriculum tunisien officiel",
    descEn: "Generate daily French language session schedule following the official Tunisian curriculum",
    gradient: "linear-gradient(135deg, #1565C0, #42A5F5)",
    iconBg: "#E3F2FD",
    previewAr: ["معلومات الوحدة والمودول", "Communication orale", "Lecture", "Grammaire / Conjugaison"],
    previewFr: ["Informations unité/module", "Communication orale", "Lecture", "Grammaire / Conjugaison"],
    previewEn: ["Unit/module info", "Oral communication", "Reading", "Grammar / Conjugation"],
    previewIcon: Calendar,
    demoSteps: 4,
  },
  {
