...
import { LayoutDashboard, LogOut, PanelLeft, Users, Gift, HelpCircle } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Gift, label: "دعوة الأصدقاء", path: "/invite-friends" },
  { icon: Users, label: "لوحة الإحالات", path: "/referral-dashboard" },
  { icon: HelpCircle, label: "الأسئلة الشائعة", path: "/referral-faq" },
];
