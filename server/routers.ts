  ...
  assistant: router({
    chat: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        const systemPrompt = `أنت EDUGPT، خبير بيداغوجي تونسي متخصص في إعداد الجذاذات والاختبارات وفق البرامج الرسمية التونسية 2026.
...
- لا روابط وهمية
- لا خلط بين المستويات الدراسية${subjectInfo}${levelInfo}${langNote}${contextNote}`;
